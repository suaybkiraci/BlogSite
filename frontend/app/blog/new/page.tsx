          ...
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={loading}
                className="rounded-full border border-border/50 bg-background/50 px-5 py-2 text-sm font-medium text-foreground transition hover:bg-muted hover:text-foreground disabled:opacity-60"
              >
